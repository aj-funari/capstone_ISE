...
# MAC = "a8:8f:15:63:27:d2"  # AJ Arduino
MAC = "66:46:6d:83:a5:c8"  # capstone Arduino
...
while(dev):
    # Try to get characterists
    # Throwing an exception means we disconnected
    try:
...
# Unused in our project, could be helpful for someone else
